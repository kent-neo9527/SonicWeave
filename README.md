...
![Main Editor Workflow](./assets/github/screen-editor-workflow.png)

> build a complete music-reactive scene inside one editor.

### 2. Effect Layering and Layout Control

![Effect Layering and Layout Control](./assets/github/screen-layered-effects.png)
...
![Effect Parameters and Audio Mapping](./assets/github/screen-parameters-mapping.png)
...
![Cinematic Music Visualization Example](./assets/github/screen-cinematic-example.png)
